            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        ...
                        <a href="cusDeleteall.php" class="btn btn-success pull-left"><i class="fa fa-trash"></i> delete all</a> 
                        <a href="http://localhost/phpwebsite/gpay.php"><button>Pay</button></a>
                    </div>
                    <?php
                    // Include config file
